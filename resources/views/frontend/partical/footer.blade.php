...
<footer class="footer-content" id="footer">
	<div class="container">
		...
		<div class="row  justify-content-center">
			...
			<div class="col-md-6 col-sm-12">
				...
				<ul class="social-media">
					...
					<li><a title="Twitter" href="https://twitter.com/"><i class="fab fa-twitter" aria-hidden="true"></i> <span class="sr-only">Twitter</span></a></li>
					<li><a title="Instagram" href="https://www.instagram.com/"><i class="fab fa-instagram" aria-hidden="true"></i> <span class="sr-only">Instagram</span></a></li>
					<li><a title="Linkedin" href="https://www.linkedin.com/"><i class="fab fa-linkedin-in" aria-hidden="true"></i> <span class="sr-only">Linkedin</span></a></li>
				</ul>
      ...
      <div class="col-md-2 col-sm-12 text-center">
		...
		<div class="row">
			<div class="col-5">
				<p class="copyright">Marketed by TekGro  </p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Apply as</h5>
