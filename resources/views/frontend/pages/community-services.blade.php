			...
			<div class="col-sm-12 col-md-8 col-lg-7">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Diploma of Community Services</li>
					</ol>
				</nav>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="course-detail">
				<h2>CHC52015 Diploma of Community Services (Case Management)</h2>
				<div class="button-lists bd-example">
					<div class="cat-name">Category : Community Services</div>
					<div class="btn-group">
				...
				<img src="{{ asset('image/community-services.jpg') }}" class="img-responsive course-detail-img">
				...
				<div class="accordion accordion-flush content-text" id="accordionFlushExample">
					<div class="accordion-item">
						...
						<div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
							<div class="accordion-body">This qualification reflects the roles of community services, such as, Case Manager, Social Housing Workers,
							Community Service Officer, involved in managing, co-ordinating and/or delivering of person-centred services
							to individuals, groups and communities.
							At this level, workers have specialised skills in community services and work autonomously under broad
							directions from senior management. Workers are usually providing direct support to individuals or groups of
							individuals. Workers may also have responsibility for the supervision of other workers and volunteers and/or
							case management, program coordination or the development of new business opportunities.
							As part of this qualification, student must successfully complete 100 hours of Work Placement at the
							Community Services sectors/organisations.
				...
				<div class="accordion-item">
					...
					<div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
						<div class="accordion-body">ANE college welcomes all international students, who
							...
							<ul>
								<li><i class="fas fa-angle-double-right"></i>Seeking to pursue or further a career in Community
 								Services</li>
				...
				<div class="accordion-item">
					...
					<div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
						<div class="accordion-body">This qualification will be delivered over 78 weeks of study. Students are also required to complete 100
				...
				<div class="accordion-item">
					...
					<div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
						<div class="accordion-body">Students who complete this course may wish to continue
						their education into CHC62015 Advanced Diploma of
						Community Sector Management or higher education
						...
						Units included in this qualification are:
							<div class="table-responsive">
								<table class="table table-striped">
									<tbody>
										<tr>
											<td>CHCCCS007 </td><td> Develop and implement service programs</td><td> Core</td>
										</tr>
										<tr>
											<td>CHCCOM003 </td><td>Develop workplace communication strategies </td><td>Core</td>
										</tr>
										<tr>
											<td>CHCDEV002</td><td> Analyse impacts of sociological factors on clients in
												community work and services
												</td><td>Core</td>
										</tr>
										<tr>
											<td>CHCDIV003</td><td> Manage and promote diversity </td><td>Core</td>
										</tr>
										<tr>
											<td>CHCLEG003</td><td> Manage legal and ethical compliance</td><td> Core</td>
										</tr>
										<tr>
											<td>CHCMGT005 </td><td>Facilitate workplace debriefing and support processes </td><td>Core</td>
										</tr>
										<tr>
											<td>CHCPRP003 </td><td>Reflect on and improve own professional practice</td><td> Core</td>
										</tr>
										<tr>
											<td>HLTWHS004 </td><td>Manage work health and safety</td><td> Core</td>
										</tr>
										<tr>
											<td>CHCDEV001 </td><td>Confirm client developmental status </td><td>Elective</td>
										</tr>
										<tr>
											<td>CHCCSM005 </td><td>Develop, facilitate and review all aspects of case
												management</td><td>
												Elective</td>
										</tr>
										<tr>
											<td>CHCCCSM006</td><td> Provide case management supervision </td><td>Elective</td>
										</tr>
										<tr>
											<td>CHCCCS004</td><td> Assess co-existing needs</td><td> Elective</td>
										</tr>
										<tr>
											<td>CHCCSM004 </td><td>Coordinate complex case requirements</td><td> Elective</td>
										</tr>
										<tr>
											<td>CHCCDE011</td><td> Implement community development strategies </td><td>Elective</td>
										</tr>
										<tr>
											<td>CHCADV002 </td><td>Provide advocacy and representation services </td><td>Elective</td>
										</tr>
										<tr>
											<td>CHCDIS008 </td><td>Facilitate community participation and social inclusions </td><td>Elective </td>
										</tr>
									</tbody>
								</table>
							</div>
