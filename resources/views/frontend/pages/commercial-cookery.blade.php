									...
									<div class="table-responsive">
										<table class="table table-striped">
											<tbody>
												<tr>
													<td>BSBDIV501 </td>
													<td>Manage diversity in the workplace </td>
													<td>Core</td>
												</tr>
												<tr>
													<td>
														BSBSUS401</td>
													<td> Implement and monitor environmentally sustainable work
														practices</td>
													<td>
														Core</td>
												</tr>
												...
												<tr>
													<td>
														SITHKOP002</td>
													<td> Plan and cost basic menus</td>
													<td> Core</td>
												</tr>
												<tr>
													<td>
														SITHKOP004</td>
													<td> Develop menus for special dietary requirements</td>
													<td> Core</td>
												</tr>
												<tr>
													<td>
														SITHKOP005</td>
													<td> Coordinate cooking operations*</td>
													<td> Core</td>
												</tr>
												<tr>
													<td>
												...
												<tr>
													<td>
														SITXWHS002 </td>
													<td>Identify hazards, assess and control safety risks</td>
													<td> Elective</td>
												</tr>
												<tr>
													<td>
