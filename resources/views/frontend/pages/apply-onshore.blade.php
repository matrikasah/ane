                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12  mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userUsi" name="stdusi" type="text" class="form-control" placeholder="Unique Student Identifier (USI)" value="{{ old('stdusi') }}"  required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userSurname" name="stdsurname" type="text" class="form-control " placeholder="Enter Your Surname" value="{{ old('stdsurname') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userGivenName" name="stdgivenname" type="text" class="form-control" placeholder="Enter Your Given Name" value="{{ old('stdgivenname') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userHomeAddress" name="stdhomeaddress" type="text" class="form-control" placeholder="Enter Your Home Address" value="{{ old('stdhomeaddress') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userSuburb" name="stdsuburb" type="text" class="form-control" placeholder="Enter Your Suburb" value="{{ old('stdsuburb') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userState" name="stdpostcode" type="number" class="form-control" placeholder="Enter Your State & Postcode" value="{{ old('stdpostcode') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="telNum" name="stdtelnum" type="number" class="form-control" placeholder="Enter Your Telephone Number" value="{{ old('stdtelnum') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userEmail" name="stdemail" type="text" class="form-control" placeholder="Enter Your Email Address" value="{{ old('stdemail') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="userDob" name="stddob" type="text" class="form-control" placeholder="Enter Your Date of Birth" value="{{ old('stddob') }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="fullName" name="fullName" type="text" class="form-control " placeholder="Enter Your Full Name" value="{{ old('fullName') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="relationship" name="relationship" type="text" class="form-control " placeholder="Relationship" value="{{ old('relationship') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="contactNum" name="contactNum" type="number" class="form-control " placeholder="Contact Number" value="{{ old('contactNum') }}" required>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="mobile" name="mobile" type="number" class="form-control " placeholder="Mobile" value="{{ old('mobile') }}" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="input-group">
                                            ...
                                            <input id="orgName" name="orgName" type="text" class="form-control" placeholder="Enter organization name" value="{{ old('orgName') }}">
                                    ...
                                    <div class="col-md-6 mt-4 ml-0">
                                        <div class="input-group">
                                            ...
                                            <input id="agentCnum" name="agentCnum" type="number" class="form-control" placeholder="Enter Contact Number" value="{{ old('agentCnum') }}">
                                        ...
                                        <div class="educationContent">
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group mt-4">
                                                    <label for="completionYear" style="text-align: left;" class="input-group-text">What YEAR did you
                                                        complete <br> the relevant
                                                        qualification?</label>
                                                    <input id="completionYear" name="yearCompletion" type="number" class="form-control" placeholder="Completion year" style="height: 64px;" value="{{ old('yearCompletion') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group mt-4">
                                            ...
                                            <input id="langbirthCoun" name="langbirthCoun" type="text" class="form-control" placeholder="Enter Your Country of Birth" value="{{ old('langbirthCoun')}}">
                                    ...
                                    <div class="col-md-12 d-flex align-items-center">
                                        <div class="input-group mt-4">
                                            <span class="input-group-text flex-column ml-0" style="margin-right: 10px;">Are you of Australian Aboriginal or
                                                ...
                                                Islander origin?
                                                <br>
                                                <span style="font: size 12px; color: #666666; margin-top: 3px;" class="spanThird">(For persons of both Aboriginal and Torres Strait
                                    ...
                                    <div class="col-md-6  ml-0">
                                        <div class="input-group mt-4">
                                            <span class="input-group-text flex-column  ml-0">Main language spoken at home if not
                                                English</span>
                                            <input name="otherlanguages" type="text" class="form-control" placeholder="Main language" value="{{ old('otherlanguages')}}">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="feesCollection mt-4 gap">
                                ...
                                <div class="student Signature mt-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-4">
                                            <input class="form-control signNdate" name="applicant_sign" type="text"  required>
                                            <p class="mt-1"><b>Applicant Signature</b></p>
                                        </div>
                                        <div class="col-md-6 mt-4">
                                            <input class="form-control signNdate mydatepicker" name="date_of_sign" value="{{ old('date_of_sign') }}" type="text"  required>
                            ...
                            <div class=" mt-4 gap">
                                ...
                                <div class="mt-3 sectionAPart">
                                    ...
                                    <div style="width: 60%;" class="input-group mt-2 giveMaxWidth ml-0">
                                        ...
                                        <input id="stdname" name="stdname"  value="{{ old('stdname') }}" type="text" class="form-control" placeholder="Enter Your Name" required>
                                        @if ($errors->has('stdname'))
                                        <div class="alert alert-danger">{{ $errors->first('stdname') }}</div>
                                        @endif
                                    </div>
                                    <div class="yourNameDesc mt-4">
                                        <p>I, <input name="stdname" value="{{ old('stdname') }}"  type="text" class="form-control nosideBorders" placeholder="Enter Your Name" required>(insert name) will create my own USI and advise ANE
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-4">
                                            <input name="applicantsign" class="form-control signNdate" type="text" required>
                                            <p class="mt-1"><b>Applicant Signature</b></p>
                                            @if ($errors->has('applicantsign'))
                                            <div class="alert alert-danger">{{ $errors->first('applicantsign') }}</div>
                                            @endif
                                        </div>
                                        <div class="col-md-6 mt-4">
                                            <input name="signdate" value="{{ old('signdate') }}"  class="form-control signNdate mydatepicker" type="text">
                                            <p class="mt-1"><b>Date</b></p>
                                            @if ($errors->has('signdate'))
                                            <div class="alert alert-danger">{{ $errors->first('signdate') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 sectionBPart">
                                    ...
                                    <div class="yourNameDescB mt-4">
                                        <p>I (insert
                                            name), <input name="stdnameB" value="{{ old('stdnameB') }}"  type="text" class="form-control nosideBorders" placeholder="Enter Name" required>
                                            @if ($errors->has('stdnameB'))
                                        <div class="alert alert-danger">{{ $errors->first('stdnameB') }}</div>
                                        @endif

                                        authorise ANE College to apply pursuant to sub-section
                                        9(2) of the Student
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-4">
                                            <input class="form-control signNdate" name="applicant_signB" type="text" required>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <input class="form-control signNdate mydatepicker" value="{{ old('date_of_signB')}}" name="date_of_signB" type="text">
