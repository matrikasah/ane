                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-4 ml-0">
                                            <div class="input-group">
                                                ...
                                                <p for="userHomeAddress" class="input-group-text"> <b>How many students does your agency brought to Australia to study in the last 12 months?: </b> 100</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mt-4">
                                ...
                                <div class="eduQualifications mt-4 gap">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p for="userHomeAddress" class="input-group-text"> <b>Name: </b> John Cena</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Institution Name: </b> John Cena</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Title: </b> John Cena</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Phone: </b> John Cena</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Fax: </b> John Cena</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Email: </b> John Cena</p>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p for="userHomeAddress" class="input-group-text"> <b>Full Name: </b> Lorem Ipsum</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Applicant Signature: </b> Lorem Ipsum</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Position: </b> Lorem Ipsum</p>
                                            <p for="userHomeAddress" class="input-group-text"> <b>Applicant Signature: </b> Lorem Ipsum</p>
                                        </div>
                                    </div>
                                </div>
